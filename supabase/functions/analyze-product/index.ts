...
## 출력 형식 (영양제인 경우)
{"product_name":"제품 정확 명칭","brand":"브랜드명 또는 null","main_ingredients":[{"name":"성분명","amount":"함량(단위포함)","daily_percent":"일일권장량% 또는 null"}],"category":"비타민|미네랄|프로바이오틱스|오메가3|기타","key_benefits":["기능성1","기능성2"],"warnings":["주의사항"],"target_age":"추천연령대 또는 null","confidence":0.0,"readable_summary":"70대 어르신도 이해할 3줄 이내 설명","good_with":["함께 섭취하면 도움이 될 수 있는 영양소 (최대 3개, 없으면 빈 배열)"],"avoid_with":["같이 드실 때 주의가 필요한 영양소 — 이유 (최대 3개, 없으면 빈 배열)"]}

confidence 기준: 0.9~1.0=모든정보확인, 0.7~0.8=일부흐릿, 0.5~0.6=제품명만확인, 0.5미만=product_name에 "(정확도 낮음)" 추가

good_with 작성 규칙:
- 이 제품의 성분을 보완하거나 흡수를 높이는 영양소만 포함
- 예: "비타민D — 칼슘 흡수를 도와줄 수 있어요"
- 의료적 효능 표현 금지. "도움이 될 수 있어요" 수준으로만 작성

avoid_with 작성 규칙:
- 성분 간 상호작용이 알려진 경우만 포함 (추측 금지)
- 예: "철분제 — 같이 드시면 흡수율이 낮아질 수 있어요. 2시간 간격을 두고 드세요"
- "금지", "절대", "위험" 등 강한 표현 사용 금지
- "전문가와 상담 후 드세요" 또는 "간격을 두고 드세요" 수준으로만 작성`
    }
